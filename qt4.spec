...
Patch9:		qt-4.8.7-clang-buildfixes.patch
...
Patch128:	http://pkgs.fedoraproject.org/cgit/rpms/qt.git/plain/qt-everywhere-opensource-src-4.8.7-gcc8_qtscript.patch
